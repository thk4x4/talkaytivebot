...
BOT_CONFIG = {
    'intents': {
        'hello': {
            ...
            'responses': ['Хай!', 'Прив', 'Хэллоу', 'Дарова', 'Салют', 'Приветствую']},
        'bye': {
            'examples': ['Пока', 'Сайонара',
                         'Покедова', 'Досвидули', 'До свидания'],
            'responses': ['До свиданья', 'Увидимся', 'Пока-пока!', 'Чао']
        },
        'how_are_you': {
        ...
        'What_do_you_want': {
            'examples': ['Чего ты хочешь', 'Чего ждешь'
                         ],
            'responses': ['Слушать музыку', 'еще поболтать',
                          'Спаать',
                          'Работаю во благо людей']
        }
    }
